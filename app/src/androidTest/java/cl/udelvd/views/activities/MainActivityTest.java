...
public class MainActivityTest {
    ...
    public void checkDisplayingTextViewsTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.tv_empty_interviewees), withText("You don't have interviewees yet"), isDisplayed()));
        textView.check(matches(withText("You don't have interviewees yet")));

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.tv_n_interviewee), withText("Displaying 0 of 0 interviewees"), isDisplayed()));
        textView2.check(matches(withText("Displaying 0 of 0 interviewees")));

        ViewInteraction imageButton = onView(
                allOf(withId(R.id.fb_new_interviewee),
                        childAtPosition(
