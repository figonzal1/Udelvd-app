...
public class ProfileActivityTest {
    ...
    @Rule
    public ActivityTestRule<PerfilActivity> mActivityTestRule = new ActivityTestRule<>(PerfilActivity.class);
    ...
    public void profileActivityTest() {
        ...
        ViewInteraction researchName = onView(
                allOf(withId(R.id.tv_nombre_investigador), withText("TestName TestLastName"), isDisplayed())
        );
        researchName.check(matches(withText("TestName TestLastName")));

        //Check match research email
        ViewInteraction researchMail = onView(
                allOf(withId(R.id.tv_email_investigador), withText("tatafel_8@hotmail.com"), isDisplayed())
        );
        researchMail.check(matches(withText("tatafel_8@hotmail.com")));

        //Check match status account
        ViewInteraction researchStatus = onView(
                allOf(withId(R.id.tv_activado), withText(mContext.getString(R.string.PERFIL_ACTIVADO)), isDisplayed())
        );
