...
public class RegisterActivityTest {
    ...
    @Rule
    public ActivityTestRule<RegistroActivity> mActivityTestRule = new ActivityTestRule<>(RegistroActivity.class);
    ...
    public void registerActivityTest() {
        ...
        ViewInteraction registerButton = onView(
                allOf(withId(R.id.btn_registrar), withText(context.getString(R.string.REGISTRAR)),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction name = onView(
                allOf(withId(R.id.et_nombre_investigador),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.il_nombre_investigador),
                                        0),
                                0)));
        ...
        ViewInteraction lastName = onView(
                allOf(withId(R.id.et_apellido_investigador),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.il_apellido_investigador),
                                        0),
                                0)));
        ...
        ViewInteraction researchEmail = onView(
                allOf(withId(R.id.et_email_investigador),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.il_email_investigador),
                                        0),
                                0)));
        ...
        ViewInteraction password = onView(
                allOf(withId(R.id.et_password_investigador),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.il_password_investigador),
                                        0),
                                0)));
        ...
        ViewInteraction confirmPassword = onView(
                allOf(withId(R.id.et_confirm_password_investigador),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.il_confirm_password_investigador),
                                        0),
                                0)));
