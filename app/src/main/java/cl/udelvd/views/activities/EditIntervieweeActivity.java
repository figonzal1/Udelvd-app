    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            if (validateFields()) {
                ...
                Date birthDate = null;
                try {
                    birthDate = Utils.stringToDate(getApplicationContext(), false, Objects.requireNonNull(etBirthDate.getText(), "etBirthDate cannot be null").toString());
    ...
    private boolean validateFields() {
        ...
        if (Objects.requireNonNull(etBirthDate.getText(), "Et birth date cannot be null").toString().isEmpty()) {
            ...
            try {
                ...
                Log.d("STRING_TO_DATE", "Future date cannot be null");
                e.printStackTrace();
            }
        }
        ...
        if (switchFalls.isChecked()) {
            ...
            if (Objects.requireNonNull(etNFalls.getText(), "Et falls cannot be null").toString().isEmpty()) {
